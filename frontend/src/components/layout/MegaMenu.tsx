        ...
        {isOpen && (
          ...
          >
            ...
            <div className="w-72 bg-white border-r border-secondary-100 py-4">
              ...
              <Link to="/categorias" className="block px-6 py-3 mt-2 text-sm text-secondary-500 hover:text-primary-600">
            ...
            <div className="flex-1 bg-secondary-50/30 p-8">
               ...
               <div className="space-y-4">
                 {currentContent.map((item, idx) => (
                   item.image ? (
                     <Link to="/proyectos" key={idx} className="flex items-center gap-4 group hover:bg-white p-2 rounded-xl transition-all">
                      ...
                      <Link to={(item as any).link || '/proyectos'} key={idx} className="block w-full py-4 text-center bg-white border border-secondary-200 rounded-xl font-bold text-secondary-800 hover:border-primary-500 hover:text-primary-600 transition-all shadow-sm">
                        {item.label}
                      </Link>
                   )
                 ))}
                 ...
                 {activeTab === 'suelos' && (
                    <Link to="/proyectos" className="block w-full py-4 text-center bg-white border border-secondary-200 rounded-xl font-bold text-secondary-800 hover:border-primary-500 hover:text-primary-600 transition-all shadow-sm mt-6">
            ...
            <div className="w-80 bg-white border-l border-secondary-100 p-8">
              ...
              <div className="space-y-6">
                {megaMenuData.recommended.map((item, idx) => (
                   <Link to="/proyectos" key={idx} className="flex items-start gap-3 group">
