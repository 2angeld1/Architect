...
function ResetPasswordForm() {
  ...
  if (success) {
    return (
      <div className="text-center py-6 font-sans">
        ...
        <Link
          href="/admin/login"
          className="inline-flex justify-center items-center gap-2 w-full py-3 px-4 rounded-xl text-sm font-semibold text-zinc-955 bg-white hover:bg-zinc-100 transition-all duration-200 active:scale-[0.98]"
        >
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5 font-sans text-zinc-300">
      {!token && (
      ...
      <div>
        ...
        <div className="relative rounded-xl shadow-sm">
          ...
          <input
            ...
            className="block w-full pl-10 pr-10 py-3 bg-zinc-900/60 border border-zinc-800/80 rounded-xl text-sm text-zinc-100 placeholder-zinc-650 focus:outline-none focus:ring-1 focus:ring-white/40 focus:border-white/40 focus:bg-zinc-900 transition-all duration-200"
            placeholder="••••••••••••"
          />
          <button
            type="button"
